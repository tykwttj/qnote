...
class $MemosTable extends Memos with TableInfo<$MemosTable, MemoEntry> {
  @override
...
class MemoEntry extends DataClass implements Insertable<MemoEntry> {
  ...
  MemoEntry copyWithCompanion(MemosCompanion data) {
    return MemoEntry(
...
class MemosCompanion extends UpdateCompanion<MemoEntry> {
...
class $$MemosTableTableManager
    extends
        RootTableManager<
          ...
          (MemoEntry, BaseReferences<_$AppDatabase, $MemosTable, MemoEntry>),
          MemoEntry,
